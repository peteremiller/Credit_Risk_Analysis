...
Now that I have completed the analysis, below is a written evaluation of the performance of the six models. I will also provide a recommendation on whether any of the models should be used to predict credit risk.
